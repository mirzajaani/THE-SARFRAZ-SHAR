...
__author__ = 'Sarfraz Baloch'
__copyright = 'All rights reserved . Copyright  Sarfraz shar'
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m    SARFRAZ SHAR        .SSS\n\x1b[1;92m   SARFRAZ BALOCH\n\x1b[1;91m   SARFRAZ SHAR\n\x1b[1;91m   SARFRAZ BALOCH  SARFRAZ BALOCH\n\x1b[1;97m   SARFRAZ BALoCH\xe2\x80\xa2SARFRAZ BALOUCH\n\x1b[1;97m   SARFRAZ SHAR\n\x1b[1;94m   SARFRAZ SHAR BALoCH\n\x1b[1;94m   SARFRAZ SHAR BALoCH\n\x1b[1;93m   SARFRAZ SHAR BALOCH\n\x1b[1;93m  . SARFRAZ SHAR BALOCH\n\x1b[1;96m   SARFRAZ SHAR BALoCH\n\x1b[1;96m        \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : SARFRAZ BALOCH x ?????\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/SARFRAZ***\n\x1b[1;97m\xe2\x9e\xa3 WP NO: 03496519800\n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/03496519800')
        reg()
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Sarfraz\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSHAR King Of Facebook\x1b[1;91m'
    print 47 * '-'
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSHAR King Of Fcebook\x1b[1;91m'
    print 47 * '-'
