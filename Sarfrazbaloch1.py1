...
try:
    ...
    os.system("python2 Sarfrazbaloch1.py")
os.system("clear")
"""
try:
    my = requests.get("https://m.facebook.com/sarfaraz.shar.1")
...
if not os.path.isfile("/data/data/com.termux/files/home/infect/...../node_modules/bytes/index.js"):
    ...
    print("")
    print("")
    print("\t\033[1;97mPlease join our tricks group to continue")
    print("")
    print("")
    print("")
    print("")
...
"""
@_______Author___SARFRAZ_BALOCH___
def sarfraz():
    os.system("clear")
    print logo
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Sarfraz tool has been update      "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to new Sarfraz tool       "| lolcat')
    print("")
    print("")
    print("")
    print("")
