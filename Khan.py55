...
def menu():
    ...
    print '[5] \x1b[1;95mUpdate Sarfraz Commands Tool.'
    print '[6] \x1b[1;95mjoin my Facebook group.'
    print '[7] Logout'
    print '                  '
    men()
...
def men():
    ...
    if rana == '':
        ...
        os.system('clear')
        sarfraz('[!] \x1b[1;92mPlease Wait While Page Is Loding.')
        hopss('10%..Wait.')
        hopss('20%.5..')
        hopss('50%..4.')
        hopss('70%.3..')
        ...
        os.system('clear')
        print banner
        sarfraz('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Tool Is Updating')
        os.system('git pull origin master')
        sarfraz('[\xe2\x9c\x93] \x1b[1;92mTool Has Been Update Successfully')
        sarfraz('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Update Is Setting Up On Your Mobile Phone')
        time.sleep(3)
        os.sarfraz('python2 Khan.py')
    elif rana == '6':
        os.system('xdg-open https://facebook.com/groups/158842324462303/')
        menu()
    elif rana == '7':
        os.system('rm -rf login.txt')
        sarfraz('[\xe2\x9c\x93] Logged Out Successfully')
        os.system('python2 Khan.py')
    else:
        print '[!] \x1b[1;91mWrong Input'
        men()
...
def crack_menu():
    ...
    if crm == '':
        ...
        print 'Filled Incorrectly'
        crack_menu()
    sarfraz('[\xe2\x9c\x93] \x1b[1;96mTotal Friends: ' + str(len(id)))
    time.sleep(0.5)
...
def idfromfriend():
    ...
    try:
        ...
        z = json.loads(r.text)
        sarfraz('[\xe2\x9c\x93] \x1b[1;92mGetting Friends Numeric IDs...')
        print '--------------------------------------'
